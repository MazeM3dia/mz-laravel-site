...
<footer id="mz-footer" class="bg-neutral-primary">
    ...
    <div class="px-4 py-6 bg-neutral-secondary-soft md:flex md:items-center md:justify-between">
        <span class="text-sm text-body sm:text-center">&copy; {{ date('Y') }} <a href="https://flowbite.com/">Flowbite™</a>. All Rights Reserved.
        </span>
